...
class reader_top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tag_decoder = tash.decoder(int(self.adc_rate / self.decim))
        self.gate = tash.gate(int(self.adc_rate / self.decim))
        self.reader = tash.reader(int(self.adc_rate / self.decim), int(self.dac_rate))
